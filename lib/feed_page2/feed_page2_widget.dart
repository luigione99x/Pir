...
class FeedPage2Widget extends StatefulWidget {
  FeedPage2Widget({Key key}) : super(key: key);

  @override
  _FeedPage2WidgetState createState() => _FeedPage2WidgetState();
}

class _FeedPage2WidgetState extends State<FeedPage2Widget> {
